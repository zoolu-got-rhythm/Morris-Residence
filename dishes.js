var king = document.getElementById('dishes'); 
...
function grid(){
 ...
 while(incro<28){ //instantly creates x number of boxes
  incro++; 
...
spawns.style.width = "65px";  
spawns.innerHTML = up + dayType[up-1] +"\n" + "of" + " " + weekDay[up-1]; //because an array starts at 0 we -1 when accessing the index root of an array.
...
//end of on switch 
            ...
            king.removeChild(king.childNodes[up+1]);
